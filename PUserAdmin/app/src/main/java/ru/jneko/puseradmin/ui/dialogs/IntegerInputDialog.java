...
public class IntegerInputDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View v = inflater.inflate(R.layout.integer_dialog, null);

        numberText = (EditText) v.findViewById(R.id.numberDialogInput);
        numberText.setText(value);

        infoMessage = (TextView) v.findViewById(R.id.numberDialogTitle);
        infoMessage.setText(title);

        builder.setView(v)
                .setPositiveButton("Commit", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        value = numberText.getText().toString();
