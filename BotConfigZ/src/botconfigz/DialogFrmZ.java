...
public class DialogFrmZ extends javax.swing.JFrame {
    ...
    public DialogFrmZ(Color c) {
        initComponents();
        this.setTitle("JNeko Robot control center dialog");
        this.setIconImage(ICON_STAR.getImage());
        BotConfigZ.ToCenterScreen(this); 

        jPanel1.setBackground(c);
        jPanel2.setBackground(c);
        jPanel3.setBackground(c.darker());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogFrmZ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
